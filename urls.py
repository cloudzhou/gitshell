...
urlpatterns = patterns('gitshell',
    ...
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/tree/?$', 'repo.views.default_tree'),
    ...
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/commits/?$', 'repo.views.default_commits'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/commits/([a-zA-Z0-9_\.\-]+)/([^\@\#\$\&\\\*\"\'\<\>\|\;]*)$', 'repo.views.commits'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/compare/?$', 'repo.views.default_compare'),
    ...
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/pull/new/?$', 'repo.views.default_pull_new'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/pull/new/(\w+):([a-zA-Z0-9_\.\-]+)\.\.\.(\w+):([a-zA-Z0-9_\.\-]+)/?$', 'repo.views.pull_new'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/pull/(\d+)/?$', 'repo.views.pull_show'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/pull/(\d+)/diff/?$', 'repo.views.pull_diff'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/pull/(\d+)/commit/?$', 'repo.views.pull_commit'),
    ...
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/diff/(\w+)/(\w+)/(\d+)/([^\@\#\$\&\\\*\"\'\<\>\|\;]*)$', 'repo.views.diff'),
    # issue
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/issues/?$', 'issue.views.issues'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/issues/(\d+)/?$', 'issue.views.default_show'),
