...
urlpatterns = patterns('gitshell',
    ...
    url(r'^explore/[a-zA-Z0-9_\-]+/?$', 'explore.views.explore'),
    ...
    url(r'^(\w+)/(\w+)/issues/delete/(\w+)/?$', 'repo.views.issues_delete'),
    url(r'^(\w+)/(\w+)/issues/update/(\w+)/(\w+)/?$', 'repo.views.issues_update'),
    url(r'^(\w+)/(\w+)/issues/list/(\w+)/(\d+)/(\d+)/(\d+)/(\w+)/(\d+)/?$', 'repo.views.issues_list'),
    url(r'^(\w+)/(\w+)/issues/comment/delete/(\w+)/?$', 'repo.views.issues_comment_delete'),
    ...
    url(r'^(\w+)/(\w+)/refs/?$', 'repo.views.repo_refs'),
    url(r'^(\w+)/(\w+)/fork/?$', 'repo.views.repo_fork'),
    url(r'^(\w+)/(\w+)/watch/?$', 'repo.views.repo_watch'),
    url(r'^(\w+)/(\w+)/unwatch/?$', 'repo.views.repo_unwatch'),
    url(r'^(\w+)/(\w+)/diff/(\w+)/(\w+)/([a-zA-Z0-9_\.\-/]*)$', 'repo.views.repo_diff'),
