...
urlpatterns = patterns('gitshell',
    ...
    url(r'^(\w+)/(\w+)/tree/?$', 'repos.views.repos_default_tree'),
    ...
    url(r'^(\w+)/(\w+)/commits/?$', 'repos.views.repos_default_commits'),
    url(r'^(\w+)/(\w+)/commits/([a-zA-Z0-9_\.\-]+)/([a-zA-Z0-9_\.\-/]*)$', 'repos.views.repos_commits'),
	url(r'^(\w+)/(\w+)/issues/?$', 'repos.views.repo_issues'),
	url(r'^(\w+)/(\w+)/issues/create/?$', 'repos.views.repo_create_issues'),
	url(r'^(\w+)/(\w+)/issues/delete/(\w+)/?$', 'repos.views.repo_delete_issues'),
	url(r'^(\w+)/(\w+)/issues/list/(\w+)/(\w+)/(\w+)/(\w+)/(\w+)/(\w+)/?$', 'repos.views.repo_list_issues'),
	url(r'^(\w+)/(\w+)/issues/create/comment/(\w+)/?$', 'repos.views.repo_create_comment'),
	url(r'^(\w+)/(\w+)/issues/delete/comment/(\w+)/?$', 'repos.views.repo_delete_comment'),
