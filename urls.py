...
urlpatterns = patterns('gitshell',
	...
	url(r'^(\w+)/(\w+)/issues/?$', 'repo.views.repo_issues'),
	url(r'^(\w+)/(\w+)/issues/create/?$', 'repo.views.repo_create_issues'),
	url(r'^(\w+)/(\w+)/issues/delete/(\w+)/?$', 'repo.views.repo_delete_issues'),
	url(r'^(\w+)/(\w+)/issues/list/(\w+)/(\d+)/(\d+)/(\d+)/(\w+)/(\d+)/?$', 'repo.views.repo_list_issues'),
	url(r'^(\w+)/(\w+)/issues/create/comment/(\w+)/?$', 'repo.views.repo_create_comment'),
	url(r'^(\w+)/(\w+)/issues/delete/comment/(\w+)/?$', 'repo.views.repo_delete_comment'),
