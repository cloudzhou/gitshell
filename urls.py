...
urlpatterns = patterns('gitshell',
    ...
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/settings/branches_permission/?$', 'repo.views.branches_permission'),
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/settings/branch_permission/([a-zA-Z0-9_\.\-]+)/?$', 'repo.views.branch_permission'),
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/settings/branch_permission/([a-zA-Z0-9_\.\-]+)/grant/?$', 'repo.views.branch_permission_grant'),
