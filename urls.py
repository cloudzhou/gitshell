...
urlpatterns = patterns('gitshell',
	...
	url(r'^(\w+)/(\w+)/issues/create/?$', 'repo.views.issues_create'),
	url(r'^(\w+)/(\w+)/issues/delete/(\w+)/?$', 'repo.views.issues_delete'),
	url(r'^(\w+)/(\w+)/issues/list/(\w+)/(\d+)/(\d+)/(\d+)/(\w+)/(\d+)/?$', 'repo.views.issues_list'),
	url(r'^(\w+)/(\w+)/issues/create/comment/(\w+)/?$', 'repo.views.issues_create_comment'),
	url(r'^(\w+)/(\w+)/issues/delete/comment/(\w+)/?$', 'repo.views.issues_delete_comment'),
