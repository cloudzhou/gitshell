...
urlpatterns = patterns('gitshell',
    ...
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/delete/?$', 'repo.views.delete'),
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/members/?$', 'repo.views.members'),
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/add_member/?$', 'repo.views.add_member'),
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/remove_member/?$', 'repo.views.remove_member'),
    ...
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/generate_deploy_url/?$', 'repo.views.generate_deploy_url'),
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/forbid_dploy_url/?$', 'repo.views.forbid_dploy_url'),
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/enable_dropbox_sync/?$', 'repo.views.enable_dropbox_sync'),
    url(r'^([a-zA-Z0-9_-]+)/([a-zA-Z0-9_\-]+)/disable_dropbox_sync/?$', 'repo.views.disable_dropbox_sync'),
