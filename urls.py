...
urlpatterns = patterns('gitshell',
    ...
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/branch/graph/([a-zA-Z0-9_\.\-]+)/?$', 'repo.views.branch_graph'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/branches/?$', 'repo.views.branches'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/tags/?$', 'repo.views.tags'),
    ...
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/diff/(\w+)\.\.(\w+)/(\d+)/', 'repo.views.diff_default'),
