...
urlpatterns = patterns('gitshell',
    ...
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/tree/([a-zA-Z0-9_\.\-]+)/([^\@\#\$\&\\\*\"\'\<\>\|\;]*)$', 'repo.views.repo_tree'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/blob/([a-zA-Z0-9_\.\-]+)/([^\@\#\$\&\\\*\"\'\<\>\|\;]*)$', 'repo.views.repo_blob'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/raw/blob/([a-zA-Z0-9_\.\-]+)/([^\@\#\$\&\\\*\"\'\<\>\|\;]*)$', 'repo.views.repo_raw_blob'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/commits/?$', 'repo.views.repo_default_commits'),
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/commits/([a-zA-Z0-9_\.\-]+)/([^\@\#\$\&\\\*\"\'\<\>\|\;]*)$', 'repo.views.repo_commits'),
    ...
    url(r'^(\w+)/([a-zA-Z0-9_\-]+)/diff/(\w+)/(\w+)/([^\@\#\$\&\\\*\"\'\<\>\|\;]*)$', 'repo.views.repo_diff'),
