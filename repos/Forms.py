...
from gitshell.repos.models import Repos, Issues, IssuesComment
...
class RepoIssuesForm(forms.ModelForm):
    class Meta:
        ...
        #    'tracker': forms.Select(choices=LANG_CHOICES),
       #     'status': forms.Select(choices=LANG_CHOICES),
       #     'priority': forms.Select(choices=LANG_CHOICES),
        }
